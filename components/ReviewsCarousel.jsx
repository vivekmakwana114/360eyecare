        ...
        {visibleReviews.map((review, idx) => (
          ...
          >
            <div>
              ...
              <p className="text-center text-gray-600 mb-6 flex-grow leading-relaxed hidden md:block">
                {review.reviewDescription.length > 345
                  ? review.reviewDescription.slice(0, 345) + "...."
                  : review.reviewDescription}
              </p>
              <p className="text-center text-gray-600 mb-6 flex-grow leading-relaxed block md:hidden">
                {review.reviewDescription.length > 208
                  ? review.reviewDescription.slice(0, 208) + "...."
                  : review.reviewDescription}
              </p>
            </div>

...
/**
 * Page Component for 'page-1' guide.
 * This file is now a dedicated static route that uses the specialized guide layout components.
 */
const Page1Guide = () => {
  ...
  return (
    <main className="pt-[110px] relative">
      ...
      {/* Dynamic Sections using specialized components */}
      ...
      {/* Global Location Section at the bottom */}
      <LocationSection />
      <FloatingBookButton />
    </main>
  );

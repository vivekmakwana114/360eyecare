...
import { guideData } from "../../../constants/guidedata/eye-exams-cost-ohip-coverage-toronto";
...
export const metadata = {
  title: "Eye Exams Toronto: Cost, OHIP Coverage and How to Choose the Right Optometrist",
  description: "Get key details on eye exams Toronto including cost, OHIP coverage and smart tips to choose the right optometrist.",
};
